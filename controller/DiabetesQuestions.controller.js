const DiabetesQuestions = require("../models/DiabetesQuestions");
...
const addNewQuestion = async (req, res) => {
  try {
    ...
    const newQuestion = await DiabetesQuestions.create({
      questionText,
      options,
      isMultipleChoice,
    });
...
const getQuestions = async (req, res) => {
  try {
    const questions = await DiabetesQuestions.find();
...
const updateNewQuestion = async (req, res) => {
  try {
    ...
    const questionForUpdate = await DiabetesQuestions.findById(id);
...
const deleteQuestionById = async (req, res) => {
  try {
    await DiabetesQuestions.findByIdAndDelete(req.params.id);
